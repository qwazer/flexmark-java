...
public class ComboConfluenceSpecTest extends ComboSpecTestCase {
    private static final String SPEC_RESOURCE = "/ext_confluence_ast_spec.md";
    private static final DataHolder OPTIONS = new MutableDataSet()
            .set(HtmlRenderer.INDENT_SIZE, 2)
            //.set(HtmlRenderer.PERCENT_ENCODE_URLS, true)
            .set(Parser.EXTENSIONS, Arrays.asList(
                    JiraConverterExtension.create()
                    , ConfluenceExtension.create()
    ...
    public ComboConfluenceSpecTest(SpecExample example) {
        super(example);
    }
